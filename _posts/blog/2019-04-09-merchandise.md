...
Each time it is used at an event, there is a new set of merchandise that can be claimed. Rather than display mismatching photos of the objects, I started drawing the items to a similar palette, and style for each event's swag store. You can see them above, most drawn quickly between meetings, or at the end of a day. Even our swag is inventory controlled on a blockchain. Retail stores likely don't have that level of inventory control! In our case, we've set it up to demonstrate our technology, and to show that it can be quick to do so. The sophistication is unnecessary for our needs, but the [hyperledger](https://www.hyperledger.org/) architecture allows us to segment independent events quickly and easily on a blockchain fabric. Always a fun little project to return to. It is neat to see how the objects accrued on my Adobe Illustrator art boards.
